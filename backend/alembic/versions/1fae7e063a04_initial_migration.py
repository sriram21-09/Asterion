...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_cdr_records_b_party_number"),
        "cdr_records",
        ["b_party_number"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_cdr_records_first_cgi"), "cdr_records", ["first_cgi"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_cdr_records_last_cgi"), "cdr_records", ["last_cgi"], unique=False
    )
    op.create_index(
        op.f("ix_cdr_records_operator"), "cdr_records", ["operator"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_confidence_results_id"), "confidence_results", ["id"], unique=False
    )
    op.create_table(
        "tracking_results",
        sa.Column("case_id", sa.Integer(), nullable=False),
