...
class PipelineResult(BaseModel):
    """Schema for the final end-to-end pipeline result.

    Attributes:
        localization: The final position estimate.
        confidence: The confidence metrics and error ellipse.
        evidence: The evidence synthesis packet.
        metadata: Pipeline metadata (execution timing, version, etc.).
    """

    localization: LocalizationResult = Field(
        ...,
        description="The final position estimate generated by the algorithm",
    )
    confidence: ConfidenceResult = Field(
        ...,
        description="The confidence metrics and error ellipse for the estimate",
    )
    evidence: dict = Field(
        ...,
        description="The audit evidence packet detailing measurement checks",
    )
    metadata: dict = Field(
