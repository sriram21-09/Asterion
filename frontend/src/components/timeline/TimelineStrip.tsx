...
export type MeasurementSourceType = 'REAL' | 'AUGMENTED_RSSI' | 'AUGMENTED_TA' | 'SIMULATED'
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    <div className="flex items-start justify-between gap-2 mb-1.5">
                      ...
                      {(() => {
                        const src = event.source || 'REAL'
                        if (src === 'AUGMENTED_RSSI') {
                          return (
                            <span
                              title="Source: AUGMENTED_RSSI — Derived using Log-Distance Path Loss model."
                              className="text-[10px] font-mono font-bold px-1.5 py-0.5 rounded border border-amber-500/30 bg-amber-500/10 text-amber-500 flex items-center gap-1 shrink-0 cursor-help"
                            >
                              <span>🧮</span> AUG RSSI
                            </span>
                          )
                        } else if (src === 'AUGMENTED_TA') {
                          return (
                            <span
                              title="Source: AUGMENTED_TA — Derived using Timing Advance distance estimation."
                              className="text-[10px] font-mono font-bold px-1.5 py-0.5 rounded border border-blue-500/30 bg-blue-500/10 text-blue-400 flex items-center gap-1 shrink-0 cursor-help"
                            >
                              <span>🧮</span> AUG TA
                            </span>
                          )
                          ...
                          return (
                            <span
                              title="Source: SIMULATED — Generated by Scenario Simulation Engine."
                              className="text-[10px] font-mono font-bold px-1.5 py-0.5 rounded border border-purple-500/30 bg-purple-500/10 text-purple-400 flex items-center gap-1 shrink-0 cursor-help"
                            >
                              <span>🧪</span> SIM
                            </span>
                          )
                          ...
                          return (
                            <span
                              title="Source: REAL — Imported directly from telecom dataset."
                              className="text-[10px] font-mono font-bold px-1.5 py-0.5 rounded border border-emerald-500/30 bg-emerald-500/10 text-emerald-500 flex items-center gap-1 shrink-0 cursor-help"
                            >
                              <span>📡</span> REAL
                            </span>
                          )
